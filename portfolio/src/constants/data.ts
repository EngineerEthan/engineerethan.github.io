...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'A full-stack e-commerce solution with React, Node.js, and real-time inventory management. Features include user authentication, payment processing, and admin dashboard.',
  ...
  },
  {
    ...
    description: 'An interactive analytics dashboard for visualizing complex datasets with charts, filters, and real-time data streaming.',
  ...
  },
  {
    ...
    description: 'This very portfolio website built with modern React, showcasing responsive design and smooth animations.',
