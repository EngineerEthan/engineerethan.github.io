      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            I'm a passionate software engineer with a love for creating digital experiences 
            that make a difference. Here's a bit more about what drives me and what I work with.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-gray-300 mb-4">
                I've been fascinated by technology and problem-solving since I was young. 
                What started as curiosity about how websites work has evolved into a career 
                focused on building meaningful software solutions.
              </p>
              <p className="text-gray-300 mb-4">
                ...
                There's something magical about turning ideas into working software.
              </p>
